...
for(var irow=0;irow<120;irow++){ 
  ...
  for(var istep=0; istep<len; istep++){
    ...
    popu1.push([istep, arrayPleC[irow][istep]]);
    popu2.push([istep, arrayPleC[irow][istep+len]]);
    popu3.push([istep, arrayPleC[irow][istep+len*2]]);
    popu4.push([istep, arrayPleC[irow][istep+len*3]]);
    popu5.push([istep, arrayPleC[irow][istep+len*4]]);
    popu6.push([istep, arrayPleC[irow][istep+len*5]]);
    popu7.push([istep, arrayPleC[irow][istep+len*6]]);
    popu8.push([istep, arrayPleC[irow][istep+len*7]]);
    popu9.push([istep, arrayPleC[irow][istep+len*8]]);
    popu10.push([istep, arrayPleC[irow][istep+len*9]]);
    
    for(var k=1;k<speNum;k++){
      if(max[k]<arrayPleC[irow][istep+len*(k-1)]) max[k] = arrayPleC[irow][istep+len*(k-1)];
    }
  ...
  pop = [pop0,pop1,pop2,pop3,pop4,pop5,pop6,pop7,pop8,pop9,pop10];
...
function mouseover(){
  ...
  switch (this.className.animVal){
    ...
    case 'cv5': d3.selectAll(".c5").style("opacity",1); break;
    case 'cv6': d3.selectAll(".c6").style("opacity",1); break;
    case 'cv7': d3.selectAll(".c7").style("opacity",1); break;
    case 'cv8': d3.selectAll(".c8").style("opacity",1); break;
    case 'cv9': d3.selectAll(".c9").style("opacity",1); break;
    case 'cv10': d3.selectAll(".c10").style("opacity",1); break;
    default: break;
  }  
}
...
var cur5 = chartsvg.append("path")
        .attr("d", chartFunction(pop[5][0]))
        .attr("stroke", color[5])
        .attr("stroke-width", 2)
        .attr("opacity", opacv)
        .attr("fill", "none")
...
var cur6 = chartsvg.append("path")
        .attr("d", chartFunction(pop[6][0]))
        .attr("stroke", color[6])
        .attr("stroke-width", 2)
        .attr("opacity", opacv)
        .attr("fill", "none")
...
var cur7 = chartsvg.append("path")
        .attr("d", chartFunction(pop[7][0]))
        .attr("stroke", color[7])
        .attr("stroke-width", 2)
        .attr("opacity", opacv)
        .attr("fill", "none")
...
var cur8 = chartsvg.append("path")
        .attr("d", chartFunction(pop[8][0]))
        .attr("stroke", color[8])
        .attr("stroke-width", 2)
        .attr("opacity", opacv)
        .attr("fill", "none")
...
var cur9 = chartsvg.append("path")
        .attr("d", chartFunction(pop[9][0]))
        .attr("stroke", color[9])
        .attr("stroke-width", 2)
        .attr("opacity", opacv)
        .attr("fill", "none")
...
var cur10 = chartsvg.append("path")
        .attr("d", chartFunction(pop[10][0]))
...
var circle10 = svg.selectAll(".c10")
    .data(loc[10])
    .enter()
    .append("circle")
    .attr("class", "c10")
...
////////////////////////////////////////////////////////////////////////////circle
      ...
      circle1.attr("cx",function(d){return xScale(d[0]);})
            ...
            .attr("r",function(d,i){
              ...
              res = i%cirNum;
              if(res<Math.round(arrayPleC[posi][posj]/ratio))
                return rScale(r1);
              else return 0;
      ...
      circle5.attr("cx",function(d){return xScale(d[0]);})
            .attr("cy",function(d){
              ix = Math.round(d[0]*100/len);
              iy = largeY[ix][1]+Math.random()*(largeY[ix][2]-largeY[ix][1]);
              //var ypos = largeY[i][1]+res*(largeY[i+1][1]-largeY[i][1])+Math.random()*(largeY[i][2]-largeY[i][1]+res*(largeY[i+1][2]-largeY[i][2]-(largeY[i+1][1]-largeY[i][1])));
      ...
      circle6.attr("cx",function(d){return xScale(d[0]);})
            .attr("cy",function(d){
              ix = Math.round(d[0]*100/len);
              iy = largeY[ix][1]+Math.random()*(largeY[ix][2]-largeY[ix][1]);
              //var ypos = largeY[i][1]+res*(largeY[i+1][1]-largeY[i][1])+Math.random()*(largeY[i][2]-largeY[i][1]+res*(largeY[i+1][2]-largeY[i][2]-(largeY[i+1][1]-largeY[i][1])));
      ...
      circle7.attr("cx",function(d){return xScale(d[0]);})
            .attr("cy",function(d){
              ix = Math.round(d[0]*100/len);
              iy = largeY[ix][1]+Math.random()*(largeY[ix][2]-largeY[ix][1]);
              //var ypos = largeY[i][1]+res*(largeY[i+1][1]-largeY[i][1])+Math.random()*(largeY[i][2]-largeY[i][1]+res*(largeY[i+1][2]-largeY[i][2]-(largeY[i+1][1]-largeY[i][1])));
      ...
      circle8.attr("cx",function(d){return xScale(d[0]);})
            .attr("cy",function(d){
              ix = Math.round(d[0]*100/len);
              iy = largeY[ix][1]+Math.random()*(largeY[ix][2]-largeY[ix][1]);
              //var ypos = largeY[i][1]+res*(largeY[i+1][1]-largeY[i][1])+Math.random()*(largeY[i][2]-largeY[i][1]+res*(largeY[i+1][2]-largeY[i][2]-(largeY[i+1][1]-largeY[i][1])));
      ...
      circle9.attr("cx",function(d){return xScale(d[0]);})
            .attr("cy",function(d){
              ix = Math.round(d[0]*100/len);
              iy = largeY[ix][1]+Math.random()*(largeY[ix][2]-largeY[ix][1]);
              //var ypos = largeY[i][1]+res*(largeY[i+1][1]-largeY[i][1])+Math.random()*(largeY[i][2]-largeY[i][1]+res*(largeY[i+1][2]-largeY[i][2]-(largeY[i+1][1]-largeY[i][1])));
      ...
      circle10.attr("cx",function(d){return xScale(d[0]);})
            .attr("cy",function(d){
              ix = Math.round(d[0]*100/len);
              iy = largeY[ix][1]+Math.random()*(largeY[ix][2]-largeY[ix][1]);
              //var ypos = largeY[i][1]+res*(largeY[i+1][1]-largeY[i][1])+Math.random()*(largeY[i][2]-largeY[i][1]+res*(largeY[i+1][2]-largeY[i][2]-(largeY[i+1][1]-largeY[i][1])));
...
////////////////////////////////////////////////////////////////////////////circle
      ...
      smallFunction.x(function(d) { return xmove+scalorS*(d[0]-100)-(i-120)-25; })
      ...
      largeFunction.x(function(d) { return xmove+scalorL*(d[0])+(i-120)-25; })
      ...
      onepili.attr("stroke-width", 2)
            .attr('transform', function(){
              return 'translate(' +(xmove+scalorS*(smallData[0][0]-100)-50-(i-120)-25)+ ',' + (ymove+scalorL*smallData[0][1]-60) + ') rotate(20)';
            });
      ...
      stalk.attr("stroke-width", 2)
            .attr('transform', function(){
              return 'translate(' +(xmove+scalorL*(largeData[100][0])-15+(i-120)-25)+',' + (ymove+scalorL*largeData[100][1]-25) + ') rotate(-30)';
            });

////////////////////////////////////////////////////////////////////////////circle
    var  xlpoint=xmove+scalorS*(smallData[0][0]-100)-(i-120)-25;
    var  xrpoint=xmove+scalorS*(smallData[100][0]-100)-(i-120)-25;
    var  ylpoint=xmove+scalorL*largeData[0][0]+(i-120)-25;
    var  yrpoint=xmove+scalorL*largeData[100][0]+(i-120)-25;
      ...
      circle1.attr("cx",function(d){
                if(d[0]<200/9) {return xScale(9/4*d[0]);}
                else {return yScale((d[0]-200/9)*9/5);}
              })
            .attr("cy",function(d){
              if(d[0]<200/9) {
...
//var count=0;var ling=0;
      circle5.attr("cx",function(d){
                if(d[0]<200/9) {return xScale(9/4*d[0]);}
                else {return yScale((d[0]-200/9)*9/5);}
              })
            .attr("cy",function(d){
...
//console.log(count);console.log(ling);
      circle6.attr("cx",function(d){
                if(d[0]<200/9) {return xScale(9/4*d[0]);}
                else {return yScale((d[0]-200/9)*9/5);}
              })
            .attr("cy",function(d){
    ...
    if(j<120){
      ...
      cur5.attr("d", chartFunction(pop[5][j]));
      cur6.attr("d", chartFunction(pop[6][j]));
      cur7.attr("d", chartFunction(pop[7][j]));
      cur8.attr("d", chartFunction(pop[8][j]));
      cur9.attr("d", chartFunction(pop[9][j]));
      cur10.attr("d", chartFunction(pop[10][j]));
    }
